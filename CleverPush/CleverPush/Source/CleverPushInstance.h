...
- (void)addSubscriptionTags:(NSArray <CPSubscription*>*)tagIds;
...
- (void)removeSubscriptionTags:(NSArray <CPSubscription*>*)tagIds;
...
- (NSMutableArray<CPSubscription*>*)getSubscriptionTopics;
