...
@implementation NSObject (CleverPushiCarousel)

- (NSUInteger)numberOfPlaceholdersInCarousel:(__unused CleverPushiCarousel *)carousel { return 0; }
- (void)carouselWillBeginScrollingAnimation:(__unused CleverPushiCarousel *)carousel {}
- (void)carouselDidEndScrollingAnimation:(__unused CleverPushiCarousel *)carousel {}
- (void)carouselDidScroll:(__unused CleverPushiCarousel *)carousel {}

- (void)carouselCurrentItemIndexDidChange:(__unused CleverPushiCarousel *)carousel {}
- (void)carouselWillBeginDragging:(__unused CleverPushiCarousel *)carousel {}
- (void)carouselDidEndDragging:(__unused CleverPushiCarousel *)carousel willDecelerate:(__unused BOOL)decelerate {}
- (void)carouselWillBeginDecelerating:(__unused CleverPushiCarousel *)carousel {}
- (void)carouselDidEndDecelerating:(__unused CleverPushiCarousel *)carousel {}

- (BOOL)carousel:(__unused CleverPushiCarousel *)carousel shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)carousel:(__unused CleverPushiCarousel *)carousel didSelectItemAtIndex:(__unused NSInteger)index {}

- (CGFloat)carouselItemWidth:(__unused CleverPushiCarousel *)carousel { return 0; }
- (CATransform3D)carousel:(__unused CleverPushiCarousel *)carousel
   itemTransformForOffset:(__unused CGFloat)offset
            baseTransform:(CATransform3D)transform { return transform; }
- (CGFloat)carousel:(__unused CleverPushiCarousel *)carousel
...
NSComparisonResult compareViewDepth(UIView *view1, UIView *view2, CleverPushiCarousel *self);

@end


@implementation CleverPushiCarousel
